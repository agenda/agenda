...
Agenda.prototype.database = function(url, collection, options) {
  ...
  this._db.ensureIndex({"name" : 1, "priority" : -1, "lockedAt" : 1, "nextRunAt" : 1, "disabled" : 1}, ignoreErrors)
          .ensureIndex({ "name" : 1, "lockedAt" : 1, "priority" : -1, "nextRunAt" : 1, "disabled" : 1 } , ignoreErrors);
...
Agenda.prototype.getJob = function() {
  var args = Array.prototype.slice.call(arguments);
  ...
  return this._db.findOne.apply(this._db, args);
};
