...
module.exports = function(url, dbConfig, cb) {
  ...
  const options = Object.assign({}, {useNewUrlParser: true, autoReconnect: true, reconnectTries: Number.MAX_SAFE_INTEGER, reconnectInterval: this._processEvery}, dbConfig.options);
